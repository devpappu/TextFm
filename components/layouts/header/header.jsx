...
const Header = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="lg:px-48 bg-blue px-6 shadow-md border-b-0 py-5 border-gray-100 bg-top-bar relative ">
        ...
        {phoneMenu && 
              ...
              <div className={`h-screen bg-white pb-4  absolute top-0 left-0  w-4/6 `}>
                ...
                <div className=''>
                  ...
                  <div className="bg-blue w-full py-2 px-6 flex justify-between items-center ">
                    <p className="text-white text-lg">Main Menu</p>
                      ...
                      {/* <p>Logout</p> */}
            {
              user.email? <Link
              href="/dashboard"
              className={` ${style.sign__btn} primary__bg__color py-2 rounded-full px-8 text-white `}
            >
              Dashboard a
            </Link> :  <>
            <Link
              href="/login"
              className={` ${style.sign__btn} text-white primary__bg__color py-2 rounded-full px-8 text-white`}
